...
There are three common use cases for planning a custom device [channel](../Key_Concepts.md#channels).
...
For one-time instances, you should use [properties](../Key_Concepts.md#properties) to transfer configuration and state information from the configuration to the engine. This transfer occurs when the system definition is deployed to the target.
...
Use the [NI VeriStand - Add Custom Device Section](https://zone.ni.com/reference/en-XX/help/372846M-01/veristandmerge/vs_add_custom_device_section_vi/) VI to create the [sections](../Key_Concepts.md#sections-and-hierarchy) that make up the custom device [hierarchy](../Key_Concepts.md#sections-and-hierarchy).
...
When you click an item in the configuration tree, a [page](../Key_Concepts.md#pages) displays in the Subpanel.
